...
public final class StarfallEntity extends Entity {
    ...
    public static void fall(ServerPlayer caster,LivingEntity quarry,Vec3 from) {
        ...
        quarry.level().playSound(null,BlockPos.containing(from),Loki.METEOR_ROAR.get(),SoundSource.WEATHER,
    ...
    private void burst(Entity direct) {
        ...
        level().playSound(null,blockPosition(),Loki.METEOR_IMPACT.get(),SoundSource.WEATHER,
