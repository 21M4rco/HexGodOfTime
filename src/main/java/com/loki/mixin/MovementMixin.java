...
import com.loki.server.Erasure;
 ...
 * enforced instead by {@link com.loki.server.TimeBranch}, which zeroes their motion every tick and puts
...
public abstract class MovementMixin {
    ...
    private void loki$hold(ServerboundMovePlayerPacket packet,CallbackInfo ci) {
