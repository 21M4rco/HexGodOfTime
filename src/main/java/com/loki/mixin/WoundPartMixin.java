...
/** Observe the posed part only for a body carrying one of Loki's embedded daggers. */
@Mixin(ModelPart.class)
public abstract class WoundPartMixin {
    @Shadow @Final private List<ModelPart.Cube> cubes;
    @Inject(method="compile",at=@At("HEAD"))
    private void loki$wound(PoseStack.Pose pose,VertexConsumer vertices,int light,int overlay,
