...
public final class Blood {
    ...
    public static final ResourceLocation POOL=Loki.id("textures/blood_pool.png");
    ...
    public static void tick(Minecraft mc,Map<Integer,Integer> bleeding,Map<Integer,List<ThrownDagger>> wounds) {
        ...
        for(var entry:bleeding.entrySet()) {
            ...
            for(int i=0;i<stacks;i++) {
                ...
                Vfx.spark(Loki.BLOOD.get(),at,new Vec3((random.nextDouble()-.5)*.03,-.04,(random.nextDouble()-.5)*.03));
            }
