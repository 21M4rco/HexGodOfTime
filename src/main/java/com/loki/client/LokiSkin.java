...
public final class LokiSkin {
   private static final int MAX_ENTRIES = 64;
   private static final long MAX_BYTES = 33554432L;
   private static final Map<UUID, LokiSkin.Entry> CACHE = new LinkedHashMap<>(16, 0.75F, true);
         ...
         if (var2.level == null) {
            ...
            if (var3 <= 0.0F) {
               ...
               if (var7 != null && var5 < var7) {
                  ...
                  LokiSkin.Entry var11 = CACHE.get(var4);
                  ...
                  if (var11 != null && var11.state == var17) {
                     ...
                     try {
                        ...
                        LokiSkin.Entry var20 = CACHE.remove(var4);
                        if (var20 != null) {
                           dispose(var20);
                        }
                        ...
                        if (!warned) {
                           warned = true;
                           LoggerFactory.getLogger("Loki/Outfit").warn("Could not compose temporal outfit; keeping the original skin", var25);
                        }
   ...
   private static LokiSkin.Entry create(UUID var0, ResourceLocation var1, AbstractTexture var2, boolean var3, TextureManager var4) {
      ...
      if (var5 >= 64 && var5 <= 1024 && var5 == var6 && var5 % 64 == 0) {
         ...
         try {
            ...
            ResourceLocation var10 = new ResourceLocation("loki", "dynamic/temporal_outfit/" + var0);
            var4.register(var10, var9);
            return new LokiSkin.Entry(var1, var2, var3, var7, var9, var10);
   ...
   private static void compose(LokiSkin.Entry var0, float var1, boolean var2, boolean var3) {
   ...
   private static void evict() {
      ...
      while ((CACHE.size() > 64 || bytes > 33554432L) && var0.hasNext()) {
         LokiSkin.Entry var1 = (LokiSkin.Entry)var0.next();
         var0.remove();
         dispose(var1);
      }
   }

   private static void dispose(LokiSkin.Entry var0) {
      var0.base.close();
   ...
   public static void clear() {
      for (LokiSkin.Entry var1 : CACHE.values()) {
         dispose(var1);
      }
   ...
   public static void tick(ClientTickEvent var0) {
      if (var0.phase == Phase.END) {
         ...
         if (++ticks % 100 == 0) {
            ...
            while (var4.hasNext()) {
               LokiSkin.Entry var5 = (LokiSkin.Entry)var4.next();
   ...
   public static final class Reload {
      ...
      public static void register(RegisterClientReloadListenersEvent var0) {
         var0.registerReloadListener((ResourceManagerReloadListener)var0x -> LokiSkin.clear());
      }
   }
}
