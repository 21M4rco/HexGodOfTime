...
public final class HexGodOfStories {
    ...
    public static final RegistryObject<EntityType<com.hexgodofstories.warping.AbyssalLeviathan>> LEVIATHAN=ENTITIES.register("abyssal_leviathan",()->EntityType.Builder.of(com.hexgodofstories.warping.AbyssalLeviathan::new,MobCategory.MONSTER).sized(4.5f,3f).clientTrackingRange(16).updateInterval(1).fireImmune().build(ID+":abyssal_leviathan"));
