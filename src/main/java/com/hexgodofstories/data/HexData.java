...
public final class HexData {
    ...
    public static final String RETURN_TAG="HexGodOfStoriesFractureReturn",LEGACY_RETURN_TAG="LokiFractureReturn";
    ...
    /** Administrative entitlement. Missing NBT is deliberately false: nobody has powers by default. */
    ...
    /** Progression is part of the entitlement: a player without access never accrues a single point. */
    public static void train(Player p,Discipline d,int xp) {
        if(!access(p))return;
