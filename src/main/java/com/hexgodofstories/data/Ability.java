...
public enum Ability {
    ...
    SLOW_FIELD(TEMPORAL,320,55,0,false,true,"Unknown","Hold M for thirty seconds to call forth a blind, catastrophic predator. Ten seconds to manifest, sixty seconds of slaughter; ten real minutes of recovery afterward. Everything it breaks restores."),
