...
public enum Ability {
    ...
    LAEVATEINN(CONJURATION,380,0,70,false,"Scepter","Manifest the Chitauri Scepter. Hit for two hearts and one second of bleed. Tap right click for a rapid blue bolt; hold it to fill the stone and release a beam that burns through up to six bodies. Every body it passes keeps a bleeding hole that slowly closes."),
