...
public enum Ability {
    ...
    WARPING(SORCERY,800,80,400,true,"Warping","Hold R on solid ground to shatter reality there, up to 28 blocks across. The point is locked when the hold begins; look anywhere. A wider tear costs more energy. G: destination. Release R to open the break for 10 seconds. Step into it to follow your victims. Crouch + X: follow your last trap. Inside a realm, R: leave freely; X: realm control.");
