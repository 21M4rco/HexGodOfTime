...
public enum Ability {
    ...
    WARPING(SORCERY,800,80,400,true,"Warping","Hold R on solid ground to fracture a dimensional trap, up to 10 by 10 blocks. G: destination. Release R to open a broken-mirror portal for 10 seconds. Step onto it to follow your victims. Crouch + X: follow your last trap. Inside a realm, R: leave freely; X: realm control.");
