...
import com.hexgodofstories.entity.ThroneSeat;
...
public final class Throne {
    ...
    public static void repel(ServerLevel level,Entity trespasser,Vec3 seat) {
        ...
        HexNetwork.fx(trespasser,"push");
        level.playSound(null,trespasser.blockPosition(),HexGodOfStories.ASCEND.get(),SoundSource.PLAYERS,.8f,.72f);
    }
