 ...
 */
public final class HexLayer extends RenderLayer<AbstractClientPlayer,PlayerModel<AbstractClientPlayer>> {
    public static final ResourceLocation MATERIAL=HexGodOfStories.id("textures/material.png"),CLOTH=new ResourceLocation("minecraft","textures/block/gray_wool.png");
    private static AuthoredMesh crown,collar;
    public HexLayer(RenderLayerParent<AbstractClientPlayer,PlayerModel<AbstractClientPlayer>> parent){super(parent);}
