...
import com.hexgodofstories.data.ErasureFragmentMath;
...
final class ErasureBuffer implements MultiBufferSource {
    ...
    @Override public VertexConsumer getBuffer(RenderType type) {
        ...
        RenderType fragment=TYPES.computeIfAbsent(type,t->new RenderType("hexgodofstories_erasure",t.format(),t.mode(),
