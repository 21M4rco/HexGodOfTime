...
public final class BranchVfx {
    ...
    private static ResourceLocation glowSheet() {
        ...
        glowSheet=bake("hexgodofstories_branch_glow",64,(u,v)->{
    ...
    private static ResourceLocation strandSheet() {
        ...
        strandSheet=bake("hexgodofstories_branch_strand",32,(u,v)->{
    ...
    private static ResourceLocation cloudSheet() {
        ...
        cloudSheet=bake("hexgodofstories_branch_cloud",64,(u,v)->{
            double r=u*u+v*v;
            if(r>=1)return 0;
